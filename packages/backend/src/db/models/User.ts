...
export class User extends Model<InferAttributes<User>, InferCreationAttributes<User>> {
  ...
  toJSON() {
    const { id, name, email, authProvider, imageUrl, lastSeen, isOnline, createdAt, updatedAt } = this.get();
    return { id, name, email, authProvider, imageUrl, lastSeen, isOnline, createdAt, updatedAt };
  }
}
